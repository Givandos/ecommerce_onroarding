...
class WarehouseFetcherTest < ActiveSupport::TestCase
  setup do
    @company = companies(:one)
    @fetcher = WarehouseFetcher.new(@company)
  end
  ...
  test "progress calculates percent based on completed steps" do
    ...
    assert_equal 60, result[:sync_percent]
  end
  ...
  test "progress returns 100 when all expected steps completed" do
    ...
    progress.complete_step!("po_upload")
